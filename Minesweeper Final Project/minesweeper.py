...
#                           Final Project:                                  #
#                                                                           #
#  Programmed by Joseph Palisoul 4-30-2016                                  #
#  Instructor:  Dean Zeller                                                 #
#                                                                           #
#  Description:  This file contains functions to initiate and run a         #
#                game of minesweeper. To restart the game you must          #
#                restart the program from this file.                        #
#                                                                           #
#  Classes:                                                                 #
#               Sprites         The creation of display objects             #
#               Mine            The runtime checking for mines              #
#               SafeSpot        The runtime checking of each click          #
#               MineSweeper     The actual execution of minesweeper         #
#                                                                           #
#  This program is copyright (c) 2016 Joseph Palisoul and Justin Raines.    #
...
#   Class Sprites                                                           #
#                                                                           #
#       This is where the creation of the display objects such as numbers   #
#       as well as the bomb is created.                                     #
#                                                                           #
#   Contains these functions:   __init__ , draw, plot_point                 #
#                                                                           #
#############################################################################
class Sprite(object):
...
#   Class Mine                                                              #
#                                                                           #
#       This is as class made to determine when a mine is clicked before    #
#       game is completed. Returning BOOM and ending the game. Making the   #
#       bombs.                                                              #
#   Contains these functions:   __init__ , draw , __srt__ , __repr__        #
#                                                                           #
#############################################################################
class Mine(object):
...
#   Class SafeSpot                                                          #
#                                                                           #
#       This is where when clicking on the screen we determine if the spot  #
#       that is clicked is safe, and then if it is we determine what        #
#       Sprite should be written into the box. Creating the blank grid.     #
#                                                                           #
#   Contains these functions:   __init__ , draw , __srt__ , __repr__        #
#                                                                           #
#############################################################################
...
#   Class MineSweeper                                                       #
#                                                                           #
#       The Minesweeper class is the actual runtime execution of the game   #
#       of minesweeper. Most error checking and gametime management         #
#       occurs here.                                                        #
#                                                                           #
#   Contains these functions:                                               #
#       __init__ , spriteSetup , gridSetup , find_adj_mines_ ,              #
#       gridloc_inbounds , screenSetup , draw_grid , right_clicked ,        #
#       toggle_box_color , clicked , screenloc_inbounds , handle_safespot , #
#       handle_mine , display_topleft_message ,                             #
#       translate_catesianxy_to_gridrc , translate_gridrc_to_cartesianxy ,  #
#       get_box_topleft_coords , zeroClicked , iterate_neighbors            #
#                                                                           #
#############################################################################
class MineSweeper(object):
    ...
    def spriteSetup(self, pixelCSV_fn):
        ...
        blackbox_pix = [[(255,0,0) for i in range(23)] for j in range(24)]
    ...
    def screenSetup(self):
        ...
        self.screen.onclick(self.right_clicked, btn=3)
        self.screen.listen()
...
#   Function Main                                                           #
#                                                                           #
#       This is where the program is first executed and begins running.     #
#                                                                           #
#############################################################################
def main():
    #Boxes
