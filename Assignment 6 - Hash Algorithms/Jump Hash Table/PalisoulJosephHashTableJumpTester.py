#########################################################################
#                 Assignment 6 - Hash Tables (Tester)(Jump)             #
#                                                                       #
...
from PalisoulJosephHashTableJump import arrayGetUser, printArray, hashAnalysis, hashsearch, hashSearchAnalysis

print("Joseph Palisoul")
print("Assignment 6 - Hash Tables\n")
print("***************************************************************************")
print("Hash Algorithm #2 - Jump")
print("***************************************************************************\n")
